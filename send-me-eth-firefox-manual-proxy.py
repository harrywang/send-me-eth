...
# add the IP of the machine running this script to you ProxyMesh account for IP authentication. 
op.add_argument('--proxy-server=fr.proxymesh.com:31280')
...
if multi_addresses:  # multiple addresses
    for i, address in enumerate(WALLET_ADDRESSES):
        ...
        sleep(randint(2, 5))  # sleep random 5-15 seconds

        # login here for the first time
        if i == 0:
            print('after login, press enter to continue...')
            input()  # this gives time to login
